...
from .db import get_products, get_info_product, add_product, add_field, delete_field, \
    get_product_name, delete_product
...
def field_edit(request, product_id, field_name):
    if request.method == "GET":
        ...
        return redirect("shop:product_info", product_id)
