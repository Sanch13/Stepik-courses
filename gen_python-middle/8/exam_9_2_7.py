...
На вход программе в первых двух строках подаются числа m и n – количество учеников, изучающих математику и
...
only_informatics = informatics - math
res = len(only_math) + len(only_informatics)
# result = len(math ^ inf)
